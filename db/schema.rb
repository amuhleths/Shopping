...
ActiveRecord::Schema.define(:version => 20101118191645) do
  ...
  add_index "user_shops", ["reset_password_token"], :name => "index_user_shops_on_reset_password_token", :unique => true
